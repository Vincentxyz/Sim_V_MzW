...
min_FIN_to_RELEASE = hbcue_release.filter(['org:resource', 'time_FIN_to_RELEASE']).groupby(['org:resource']).min()
min_FIN_to_RELEASE.columns = ['min_FIN_to_RELEASE']
mean_FIN_to_RELEASE = hbcue_release.filter(['org:resource', 'time_FIN_to_RELEASE']).groupby(['org:resource']).mean()
mean_FIN_to_RELEASE.columns = ['mean_FIN_to_RELEASE']
max_FIN_to_RELEASE = hbcue_release.filter(['org:resource', 'time_FIN_to_RELEASE']).groupby(['org:resource']).max()
...
min_RELEASE_to_CODE_OK = hbcue_code_ok.filter(['org:resource', 'time_RELEASE_to_CODE_OK']).groupby(['org:resource']).min()
min_RELEASE_to_CODE_OK.columns = ['min_RELEASE_to_CODE_OK']
mean_RELEASE_to_CODE_OK = hbcue_code_ok.filter(['org:resource', 'time_RELEASE_to_CODE_OK']).groupby(['org:resource']).mean()
mean_RELEASE_to_CODE_OK.columns = ['mean_RELEASE_to_CODE_OK']
max_RELEASE_to_CODE_OK = hbcue_code_ok.filter(['org:resource', 'time_RELEASE_to_CODE_OK']).groupby(['org:resource']).max()
...
min_CODE_OK_to_BILLED = hbcue_billed.filter(['org:resource', 'time_CODE_OK_to_BILLED']).groupby(['org:resource']).min()
min_CODE_OK_to_BILLED.columns = ['min_FIN_to_RELEASE']
mean_CODE_OK_to_BILLED = hbcue_billed.filter(['org:resource', 'time_CODE_OK_to_BILLED']).groupby(['org:resource']).mean()
mean_CODE_OK_to_BILLED.columns = ['mean_FIN_to_RELEASE']
max_CODE_OK_to_BILLED = hbcue_billed.filter(['org:resource', 'time_CODE_OK_to_BILLED']).groupby(['org:resource']).max()
...
time_stats_per_user = min_FIN_to_RELEASE.merge(mean_FIN_to_RELEASE, how = 'outer', left_index = True, right_index = True)
time_stats_per_user = time_stats_per_user.merge(max_FIN_to_RELEASE, how = 'outer', left_index = True, right_index = True)
time_stats_per_user = time_stats_per_user.merge(min_RELEASE_to_CODE_OK, how = 'outer', left_index = True, right_index = True)
time_stats_per_user = time_stats_per_user.merge(mean_RELEASE_to_CODE_OK, how = 'outer', left_index = True, right_index = True)
time_stats_per_user = time_stats_per_user.merge(max_RELEASE_to_CODE_OK, how = 'outer', left_index = True, right_index = True)
time_stats_per_user = time_stats_per_user.merge(min_CODE_OK_to_BILLED, how = 'outer', left_index = True, right_index = True)
time_stats_per_user = time_stats_per_user.merge(mean_CODE_OK_to_BILLED, how = 'outer', left_index = True, right_index = True)
time_stats_per_user = time_stats_per_user.merge(max_CODE_OK_to_BILLED, how = 'outer', left_index = True, right_index = True)
time_stats_per_user = time_stats_per_user.merge(total_times.filter(['availability']), how = 'outer', left_index = True, right_index = True)
